<section class="bg-black">
    <div class="bg-left-bottom bg-no-repeat bg-[url('/wp-content/uploads/2023/05/FabisemBg.png')] bg-contain bg-blend-multiply">
        <div class="px-4 flex py-14 lg:py-48">
            <div class="w-1/3"></div>
            <div class="w-2/3 lg:px-12">
                <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">Fabiana Abath. Especialista em gestão e desenvolvimento de carreira</h1>
                <p class="text-2xl font-normal text-gray-300">Apoiando profissionais a construírem a carreira que desejam. E empresas a desenharem soluções em gestão e desenvolvimento de pessoas.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="my-12">
    <div class="lg:max-w-7xl mx-auto py-20">
        <h1 class="mb-16 text-4xl font-extrabold leading-none tracking-tight md:text-5xl lg:text-6xl">Eu acredito que a verdadeira transformação no mundo do trabalho deve ser realizada em conjunto: por profissionais e pelas empresas.</h1>
...
<section class="py-12 bg-gradient-to-b from-blue-100 to-white">
    <div class="bg-center bg-no-repeat bg-[url('/wp-content/uploads/2023/05/Pattern.png')] bg-blend-multiply">
        <div class="p-12">
            ...
            <div class="grid grid-cols-4 items-stretch gap-8">
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                    <a href="#">
                        <img class="rounded-t-lg" src="/wp-content/uploads/2023/05/ContentImageOpacless.png" class="h-60">
                    </a>
                    <div class="p-5 flex flex-col justify-stretch">
                        <a href="#">
                ...
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                    ...
                    <div class="p-5 flex flex-col justify-between">
                        ...
                        <p class="mb-3 font-normal text-gray-700">Conheça as soluções educacionais para quem trabalha ou deseja trabalhar com Orientação de Carreira. <span class="text-white">Conheça as soluções educacionais</span></p>
                        <a href="#" class="flex justify-center px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-full hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300">
                            Ver detalhes
                        </a>
                    </div>
...
<section class="my-16 p-16">
    <div class="mx-auto flex items-center gap-16">
        <div class="w-3/4">
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="lg:max-w-5xl mx-auto flex items-stretch gap-6">
            <div class="w-3/4 flex flex-col gap-5 justify-between">
                ...
                <div class="flex">
                    <div class="w-1/2">
                        <img src="/wp-content/uploads/2023/05/ContentImageOpacless.png" class="h-full object-center">
                    </div>
                    <div class="w-1/2 p-6 bg-blue-50 flex flex-col">
                        <span class="text-xs font-semibold text-blue-700 tracking-wider">Grafic Design</span>
                        <h2 class="text-lg font-bold mb-2">Design is a Plan or The Construction of an Object.</h2>
            ...
            <div class="w-1/4 flex flex-col divide-y divide-gray-300 bg-emerald-900 px-4 py-3">
...
<section class="bg-indigo-950 bg-blend-multiply">
    <div class="lg:max-w-2xl mx-auto py-20">
