...
<section class="bg-gray-900 lg:hidden">
    <div class="container pt-14">
        <h1 class="text-center mb-6 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl">Fabiana Abath. Especialista em gestão e desenvolvimento de carreira</h1>
        <p class="text-center text-xl font-normal text-gray-300">Apoiando profissionais a construírem a carreira que desejam. E empresas a desenharem soluções em gestão e desenvolvimento de pessoas.</p>
    </div>
