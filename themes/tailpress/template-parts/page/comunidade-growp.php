...
<section class="bg-gray-900 lg:hidden lg:px-16">
    <div class="container pt-14">
        ...
        <a class="text-white bg-custom hover:bg-custom focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none">Quero fazer parte</a>
    </div>
    <div class="h-96 bg-left-bottom bg-no-repeat bg-[url('/wp-content/uploads/2023/05/1478sembg.png')] bg-contain bg-blend-multiply">
    </div>
</section>

<section class="bg-slate-100 py-12 lg:py-20 lg:px-16">
    <div class="container mx-auto lg:max-w-7xl">
        <h2 class="text-3xl lg:text-5xl text-center tracking-tight font-extrabold text-custom mb-4">Na comunidade GROWP você vai receber:</h2>
        <div class="container mx-auto lg:max-w-4xl py-8 lg:py-12 grid grid-cols-1 lg:grid-cols-2 self-stretch gap-20">
            <div class="bg-white rounded-3xl p-5 flex flex-col justify-between border-b-4 border-custom">
                ...
                <p class="text-center m-0 px-3">Aulas gravadas organizadas em quatro categorias: A prática em Orientação de Carreira, Sociedade e Trabalho, Organizacional, Cuidando da sua carreira.</p>
            </div>
            <div class="bg-white rounded-3xl p-5 flex flex-col justify-between border-b-4 border-custom">
                <div class="flex justify-center mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-camera-reels-fill text-gray-900" viewBox="0 0 16 16">
            ...
            <div class="bg-white rounded-3xl p-5 flex flex-col justify-between border-b-4 border-custom">
                ...
                <h4 class="text-lg lg:text-2xl text-center tracking-tight font-bold text-gray-900 mb-2">Técnicas de OPC</h4>
...
<section class="py-12 lg:py-20 lg:px-16">
    <div class="container mx-auto lg:max-w-7xl">
        <h1 class="text-5xl tracking-tight font-extrabold text-custom mb-4">Agora você pode fazer parte comunidade com as melhores Orientadoras de Carreira do Brasil</h1>
        ...
        <div class="container mx-auto lg:max-w-4xl flex flex-col lg:flex-row gap-12 mb-6">
            <div class="">
                <div class="flex items-center gap-3 p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-x-square text-custom" viewBox="0 0 16 16">
                        <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                        <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                    </svg>
                    <p class="text-lg text-custom m-0">pouco tempo disponível para estudar e se manter atualizada.</p>
                </div>
            </div>
            <div class="">
                <div class="flex items-center gap-3 p-3">
                    ...
                    <p class="text-lg text-custom m-0">grana curta para investir em tantos livros e cursos disponíveis.</p>
                </div>
            </div>
        </div>
...
<section class="bg-gray-900 py-12 lg:py-16 lg:px-16">
    <div class="container lg:max-w-7xl mx-auto">
        ...
        <div class="container mx-auto lg:max-w-4xl py-6 lg:py-12 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
            <div class="">
                <div class="">
                    <div class="p-2 bg-custom rounded-md mb-4 w-fit">
...
<section class="py-12 lg:py-16 lg:px-16">
    <div class="container lg:max-w-7xl mx-auto">
        <h1 class="text-5xl tracking-tight font-extrabold text-custom mb-4">Confira as aulas que já estão disponíveis para você acessar:</h1>
        <span class="flex bg-gray-900 h-1 w-10 mb-8 lg:mb-12 rounded-xl"></span>
    ...
    <div class="container lg:max-w-7xl mx-auto">
        ...
        <ul class="grid gap-6">
            <li class="flex items-center text-white gap-3 text-lg">
                <div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-check-circle text-custom" viewBox="0 0 16 16">
...
<section id="planos" class="py-12 lg:py-16 lg:px-16">
    <div class="container lg:max-w-7xl mx-auto">
        <h1 class="text-5xl tracking-tight font-extrabold text-custom mb-4">Escolha o melhor plano de assinatura para você!</h1>
        <span class="flex bg-gray-900 h-1 w-10 mb-8 lg:mb-12 rounded-xl"></span>
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          ...
          <p class="text-center mt-5">*Refere-se ao pagamento à vista.</p>
        </div>
...
<section class="bg-white lg:px-16">
...
<section class="bg-blue-50 py-8 lg:px-16">
...
<section class="bg-white lg:max-w-7xl mx-auto lg:px-16">
    <div class="container px-6 py-12 mx-auto">
        ...
        <div class="w-full text-center mt-10">
            <a href="/comunidade-growp/#planos" class="text-white bg-custom hover:bg-transparent hover:text-black transition duration-300 ease-in-out border-custom border-y border-x focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-lg px-5 py-2.5 mr-2 mb-2 focus:outline-none cursor-pointer">Quero começar agora</a>
        </div>
    </div>
</section>